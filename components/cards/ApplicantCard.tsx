...
const ApplicantCard = ({
  ...
  return (
    <div className='applicantCard flex justify-between max-w-[250px] gap-4 rounded-[4px] p-2  '>
        <Link href={`/candidates/information/${"htkntnngdd"}`}>
        <div className='flex flex-row gap-2 items-start justify-center'>
            <div className='flex items-start justify-start'>
                <img className='h-[40px] w-[41px] ' alt='profile-img' src={passport}/>
            </div>
            <div className='flex flex-col items-center text-left justify-center'>
                <h1 className='text-[16px] font-[400] '>{name}</h1>
                <h3 className='candidateExperienceColor text-[12px] font-[500] '>{yearsofexperience} year Experience</h3>
                ...
                <div >
                    <BiLogoLinkedin className='' size={25}/>
